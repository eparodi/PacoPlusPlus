	...
	int main() {
		...
		startTypes();
		buildOpTable();
_object var1=createInt(0);
printObject(createInt(0));
printf("\n");
while(ltInt(var1,createInt(5))->cont.num){
printObject(var1);
printf("\n");
var1=addIntInt(var1,createInt(1));

}
if(ltInt(createInt(10),createInt(8))->cont.num){
